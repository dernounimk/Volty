              ...
              <div className={`relative transition-all duration-500 ease-in-out overflow-hidden ${
                ...
                <div className="relative min-w-[192px] lg:min-w-[256px]">
                  ...
                  <input
                    ...
                    type="text"
                    className="w-full pl-10 pr-10 py-2.5 bg-white dark:bg-gray-800 border-2 border-gray-200 rounded-2xl text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 transition-all duration-300 shadow-sm"
